...
void show_all_book()
{
    ...
    else
    {
        ...
        for(i=0;i<N;i++)
        {
        	printf("\t%-4d %-8s %-8s  %4d年%2d月%2d日     ",bk[i].num,bk[i].name,bk[i].publish,bk[i].t.year,bk[i].t.month,bk[i].t.day);
            if(bk[i].jie==0)
            printf("未借阅\n");
            else
            printf("已借阅\n");
...
int main()
{
    ...
    do
    {
        ...
        switch(x)
        {
            	...
            	if(s==1)
            {
                ...
                switch(x2)
                {
                    ...
                    case 4:system("cls");dele();break;/*删除图书*/
                    case 5:system("cls");xiugaimima();break;/*修改密码*/
                } 
            }
            else
            {
        ...
        do
        {
            ...
            switch(x2)
            {
            	case 1:show();getch();break;//system("cls");show();getch();break;/*查看图书信息*/
                case 2:jieyue();getch();break;//system("cls");jieyue();getch();break;/*借阅图书*/
            }    
        }while(x2!=3);
    }
  }while(x!=3);
