...
static void freeObject(void *ptr)
{
    ...
    /*if (prev_free_header == NULL)*/
    /*{*/
        /*// Start a new header to potentially be coallesced with.*/
        /*free_header = (FreeObject *) ((void *) boundary_header);*/
        /*free_header->boundary_tag = *boundary_header;*/
        /*free_header->free_list_node._prev = _freeList;*/
        /*free_header->free_list_node._next = _freeList->free_list_node._next;*/
        /*_freeList->free_list_node._next = free_header;*/
    ...
    /*if (next_free_header != NULL)*/
    /*{*/
        /*// Coallesce with the block below.*/

    /*}*/

    /*// Coallesce with the block above if possible.*/
    /*if (! isAllocated(prev_boundary_header))*/
    /*{*/
        /*// Expand to the size of the allocated space's boundary tag and allocated*/
        /*// size.*/
    ...
    /*// Coallesce with the block below if possible.*/
    /*if (! isAllocated(next_boundary_header))*/
    /*{*/
        /*// Next segment is free, coallesce.*/
        /*setSize(&free_header->boundary_tag, getSize(&free_header->boundary_tag)*/
                /*+ getSize(next_boundary_header) + sizeof(BoundaryTag));*/

        /*// Splice the old Free List Node.*/
        /*FreeObject* node_ptr = next_free_header->free_list_node._next;*/
        /**(next_free_header->free_list_node._prev)->free_list_node._next = *node_ptr;*/

        /*node_ptr = next_free_header->free_list_node._prev;*/
        /**(next_free_header->free_list_node._next)->free_list_node._prev = *node_ptr;*/
    /*}*/
