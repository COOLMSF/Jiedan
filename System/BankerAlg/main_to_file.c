...
int main(){
      ...
      for(m = 0; m < resource; m++) {
            ...
            fprintf(fout, "\t%d ", maximum_resources[m]);
      }
      ...
      for(m = 0; m < process; m++) {
            for(n = 0; n < resource; n++) {
                  ...
                  fprintf(fout, "\t%d", maximum_claim[m][n]);
            }
            printf("\n");
            fprintf(fout, "\n");
      }
      ...
      for(m = 0; m < resource; m++) {
            ...
            fprintf(fout, "\t%d", allocation_table[m]);
      }
      for(m = 0; m < resource; m++) {
