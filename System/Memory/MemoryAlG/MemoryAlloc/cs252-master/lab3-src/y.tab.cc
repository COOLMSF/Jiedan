...
{
       0,   253,   253,   257,   258,   262,   266,   273,   280,   283,
     287,   293,   294,   298,   363,   372,   373,   377,   385,   393,
     401,   412,   421,   437,   438,   442
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "SUBCOMMAND", "NOTOKEN",
  "NEWLINE", "PIPE", "GREAT", "LESS", "GREATGREAT", "TWOGREAT", "GREATAMP",
  "GREATGREATAMP", "AMP", "$accept", "goal", "commands", "command",
  "simple_command", "command_and_args", "argument_list", "argument",
  "command_word", "iomodifier_opt_list", "iomodifier_opt", "pipe_opt_list",
  "pipe_opt", YY_NULLPTR
};
#endif
...
{
      10,    -5,    -7,    -7,    14,     9,    -7,    -7,    -7,    -7,
      -7,    -7,    -7,    11,    16,    17,    -6,    -7,    -7,    -7,
      -7,    -7,    18,    19,    20,    21,    22,    23,    24,    -7,
      -7,    -7,    -7,    -7,    -7,    -7,    -7
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       9,     1,     4,    16,    10,     0,     0,    23,    13,    11,
      25,     6,     0,     0,     0,     0,     0,     0,     0,    15,
      17,    18,    21,    19,    20,    22,     7
};
...
{
      21,    10,    22,    23,    24,    25,    26,    27,    28,    -2,
       1,     1,     2,     2,    11,     3,     3,    12,    15,    18,
       2,    30,    31,    32,    33,    34,    35,     0,    20,     0,
      36
};

static const yytype_int8 yycheck[] =
{
       6,     6,     8,     9,    10,    11,    12,    13,    14,     0,
       1,     1,     3,     3,     0,     6,     6,     5,     7,     3,
       3,     3,     3,     3,     3,     3,     3,    -1,    15,    -1,
       6
};
...
static const yytype_uint8 yystos[] =
{
       ...
       6,     0,    18,    26,    21,     7,    24,    27,     3,    22,
      20,     6,     8,     9,    10,    11,    12,    13,    14,    25,
       3,     3,     3,     3,     3,     3,     6
};
...
#line 298 "shell.y" /* yacc.c:1646  */
    {
    char* cleaned = (char *) malloc(sizeof(char) * ( strlen((yyvsp[0].string_val))));
    int orgIndex = 0;
    int cleanIndex = 0;

    for ( ; orgIndex < strlen((yyvsp[0].string_val)) ; ) {
      if ((yyvsp[0].string_val)[orgIndex] == '\\') {
        orgIndex++;
      }

      cleaned[cleanIndex] = (yyvsp[0].string_val)[orgIndex];

      if ((yyvsp[0].string_val)[orgIndex] == '\0') {
        break;
      }
...
#line 1650 "y.tab.cc" /* yacc.c:1646  */
    break;
...
#line 1664 "y.tab.cc" /* yacc.c:1646  */
    break;
...
#line 1682 "y.tab.cc" /* yacc.c:1646  */
    break;
...
#line 1691 "y.tab.cc" /* yacc.c:1646  */
    break;
