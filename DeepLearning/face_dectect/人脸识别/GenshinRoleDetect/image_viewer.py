...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        self.button1.setIcon(QIcon(('image/play.png')))
        ...
        self.button2.setIcon(QIcon(('image/back_icon.png')))
        ...
        self.button3.setIcon(QIcon(('image/forward_icon.png')))
        ...
        self.button4.setIcon(QIcon(('image/power_off.png')))
    ...
    def display_image(self):
        ...
        title_name =face_detect(self.files[self.count])
